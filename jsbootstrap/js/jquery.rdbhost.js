...
(function ($, window) {
    ...
    /*
     * loginOpenId - handles _login functionality, including processing auth info passed in
     *   the hash string, or auth info in cookie named 'OPENID_KEY'.
     *
     *   Creates _login cookie of client chosen name, with auth key returned from rdbhost server.
    ...
    /*
     loginAjax submits _login info, gets list of roles / authcodes
    ...
    /*
     trainAjax submits _login info, establishes training mode for 8 seconds
